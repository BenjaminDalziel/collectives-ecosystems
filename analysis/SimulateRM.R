# C-R Collectives: Simulate Rosenzweig-MacArthur model for specified parameters
#
# Oct 15, 2018

SimulateRM <- function(para, times, Nmax = 4000, Pmax = 1000, y = 0, correction = 1){
  ...
  # Location of Hopf bifurcation (assuming y = 0)
  a <- c * x
